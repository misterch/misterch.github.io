import{_ as n,o as s,c as a,a as t}from"./app-d37f2b5a.js";const e={},p=t(`<h2 id="递归将链表逆置" tabindex="-1"><a class="header-anchor" href="#递归将链表逆置" aria-hidden="true">#</a> 递归将链表逆置</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Node</span><span class="token punctuation">(</span><span class="token parameter">val</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
