import{_ as e,r as i,o as t,c as l,b as n,e as c,d as p,a as s}from"./app-b40860b9.js";const o={},r=s(`<h2 id="配置文件解析" tabindex="-1"><a class="header-anchor" href="#配置文件解析" aria-hidden="true">#</a> 配置文件解析</h2><p>配置文件主要由三个配置快组成 </p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#全局块</span>
